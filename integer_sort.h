...
int64_t MERGE_SORT_THRESHOLD = 179;
...
const int64_t THRESHOLD_INSERTION_FOR_QUICK[] = {};
const int64_t THRESHOLD_QUICK_FOR_MERGE[] = {};
const int64_t THRESHOLD_MERGE_FOR_QUICK[] = {};
